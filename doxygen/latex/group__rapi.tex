...
This function is called by .Call from R it takes no parameters and returns a list of lists detailing the implemented problem set. The lists are returned via the standard R S\-E\-X\-P pointer. \begin{DoxyReturn}{Returns}
