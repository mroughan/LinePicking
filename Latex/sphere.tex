...
\begin{figure}[tbp]
  \begin{center}
    ...
    example.]{\includegraphics[width=0.4\columnwidth]{../Matlab/Plots/LinePicking_test_sim_sphere_eg.eps}} 
    \hspace{6mm}
    \subfloat[\label{fig:sphere_pdf}PDF of $n$-balls.]{\includegraphics[width=0.48\columnwidth]{../Matlab/Plots/LinePicking_test_sim_sphere.eps}}
