...
\begin{figure}[tbp]
  \begin{center}
    \subfloat[\label{fig:rect_max_pdf}PDF for $a=1$ and $b=2.5$..]{\includegraphics[width=0.48\columnwidth]{../Matlab/Plots/LinePicking_test_rect_max_regions.eps}}
      \hspace{3mm}
    \subfloat[\label{fig:rect_max_pdf_var}PDF for various aspect
    ratios $a \! : \! b$ with $\max(a,b)=1$.]{\includegraphics[width=0.48\columnwidth]{../Matlab/Plots/LinePicking_test_rect_max.eps}}
