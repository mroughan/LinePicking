...
\begin{figure}[tbp]
  \begin{center}
       {\includegraphics[width=0.48\columnwidth]{../Matlab/Plots/LinePicking_plot_rect_metrics.eps}}
    \caption{Comparison of different metrics for line picking on the
      rectangle (aspect ratio 1:2, and the same support).}
    \label{fig:rect_metrics}
  \end{center} 
\vspace{-4mm}
\end{figure}  
