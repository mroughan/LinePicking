...
\begin{figure}[tbp]
  \begin{center}
    ...
    Example.]{\includegraphics[width=0.4\columnwidth]{../Matlab/Plots/LinePicking_test_sim_rect_eg.eps}} 
    \hspace{6mm}
    \subfloat[\label{fig:rect_pdf}PDF of rectangle with various aspect
    ratios.]{\includegraphics[width=0.48\columnwidth]{../Matlab/Plots/LinePicking_test_rect.eps}}
