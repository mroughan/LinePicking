...
\begin{figure}[tbp]
  \begin{center}
    ...
    \subfloat[rectangle with Manhattan distances]{\includegraphics[width=0.32\columnwidth]{../Matlab/Plots/LinePicking_test_sim_rect_man.eps}} 
    \subfloat[rectangle with Manhattan distances]{\includegraphics[width=0.32\columnwidth]{../Matlab/Plots/LinePicking_test_sim_rect_max.eps}} 
