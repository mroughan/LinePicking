...
Thus we can write:
\begin{eqnarray}
  g^{n-{\rm sphere}}_{n,R}(t) & = & \left|\frac{2}{\sqrt{4 R^2 -t^2 }} \right| g_{\Phi}\left( \cos^{-1} \left[1-\frac{t^2}{2 R^2}\right]\right)\\
  \label{eq:nsphere_pdf_phi}
             & = &\frac{t \left(\frac{t^2}{R^2} -\frac{t^4}{4 R^4}\right)^{\frac{1}{2} (n-2)} \Gamma\left[\frac{1+n}{2}\right]}{\sqrt{\pi } R^2 \Gamma\left[\frac{n}{2}\right]} 
\end{eqnarray}
using the fact that $\sin\big( \cos^{-1}(x) \big) = \sqrt{1 - x^2}$.

The obvious special cases are the circle and the 2-sphere where the
above becomes:
\begin{eqnarray}
  g^{n-{\rm sphere}}_{1,R}(t) 
   & = &\frac{t \left(\frac{t^2}{R^2} -\frac{t^4}{4 R^4}\right)^{-\frac{1}{2}}}{\pi R^2}, \\
