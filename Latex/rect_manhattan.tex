...
\begin{figure}[tbp]
  \begin{center}
    \subfloat[\label{fig:rect_man_eg}Example.]{\includegraphics[width=0.31\columnwidth]{../Matlab/Plots/LinePicking_test_sim_rect_man_eg.eps}}
    \hspace{3mm}
    \subfloat[\label{fig:rect_man_pdf}The PDF for $a=1$, $b=2.5$,
    showing the three
    regions.]{\includegraphics[width=0.31\columnwidth]{../Matlab/Plots/LinePicking_test_rect_man_regions.eps}}
    \hspace{3mm}
    \subfloat[\label{fig:rect_man_pdf_various}The PDF for various
    aspect ratios $a \! : \! b$ with
    $a+b=1$.]{\includegraphics[width=0.31\columnwidth]{../Matlab/Plots/LinePicking_test_rect_man.eps}}
