...
\begin{figure}[tbp]
  \begin{center}
        ...
        \subfloat[cylindrical surface]{\includegraphics[width=0.24\columnwidth]{../Matlab/Plots/LinePicking_test_sim_cylindrical_surface.eps}}
        \subfloat[cylindrical surface geodesic]{\includegraphics[width=0.24\columnwidth]{../Matlab/Plots/LinePicking_test_sim_cylindrical_surface_geodesic.eps}}
        \subfloat[cylinder]{\includegraphics[width=0.24\columnwidth]{../Matlab/Plots/LinePicking_test_sim_cylinder.eps}}
        \subfloat[cube max]{\includegraphics[width=0.24\columnwidth]{../Matlab/Plots/LinePicking_test_sim_cube_max.eps}}

        \subfloat[4-cube max]{\includegraphics[width=0.24\columnwidth]{../Matlab/Plots/LinePicking_test_sim_4-cube_max.eps}}
