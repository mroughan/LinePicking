%
% distance_dist_numerical.m, (c) Matthew Roughan, 2012
%         
...
xlabel('s');
ylabel('-G''(s)/G(s)');
print('-depsc', 'Plots/distance_dist_numerical_laplace_ratio.eps');
...
print('-depsc', 'Plots/distance_dist_numerical_time.eps');
...
print('-depsc', 'Plots/distance_dist_numerical_error.eps');
...
print('-depsc', 'Plots/distance_dist_numerical_rel_error.eps');
